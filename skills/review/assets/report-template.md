...
（当审查范围为 **工作区未提交变更** 时，不填上述四项，仅保留「审查范围：当前工作区未提交的变更（已暂存 + 未暂存）」）
...
> **适用说明**：本节仅当审查范围为 **指定提交** 时填写（有 commit message 可对照）。审查范围为 **工作区未提交变更** 时本节**可省略**；若用户在前文说明了修改目的，可在此简要写「修改目的验证」并评价变更是否贴合目的。
